...
const AddtoBag = (props) => (
  ...
  <div className="DPmini_cart">
    <div style={{
      ...
      overflow: "hidden",
      opacity: `${props.addtobag ? "1" : "0"}`,
      maxWidth: `${props.addtobag ? "100%" : "0"}`,
      padding: `${props.addtobag ? "15px" : "0 15px"}`,
      background: 'white',
      marginLeft: "200px"
    }}>
      <div className="DPcartheader_middle">
      <img className="DPsize_is_addimage" onClick={() => props.addToBagToggle()} src="/icons/Screen Shot 2019-12-12 at 11.12.40 AM.png"/><span>Shopping Bag</span></div>
      ...
      <button className="DPadd_button">Checkout</button>
        <div className="DPcartItem_container">
          ...
          <div className="DPgothamPro" style={{fontSize: "14px"}}>
