...
const AddtoBag = (props) => (
  <div className="DPmini_cart">
    <div style={{ display: "block", width: "320px", height: "100%", position: "absolute", right: "0px", top: "190px", zIndex: "101", transition: "all 0.5s", transitionTimingFunction: "linear", overflow: "hidden", opacity: `${props.addtobag ? "1" : "0"}`, maxWidth: `${props.addtobag ? "100%" : "0"}`, padding: `${props.addtobag ? "15px" : "0 15px"}`, background: 'white', marginLeft: "100%"}}>
